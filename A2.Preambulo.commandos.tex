...
% 1 Información del Documento %
\newcommand{\pfctitlename}{Reconocimiento de códigos de barras mediante dispositivos móviles y su aplicación a la industria textil}
\newcommand{\pfcauthorname}{Daniel López Pedrosa}
\newcommand{\pfctutorname}{Ernesto Pimentel Sánchez}
\newcommand{\pfcanno}{2015}
\newcommand{\pfcescuela}{Escuela Técnica Superior de Ingeniería Informática}
\newcommand{\pfcuma}{Universidad de Málaga}
\newcommand{\pfcsistemas}{Ingeniería Técnica en Informática de Sistemas}
