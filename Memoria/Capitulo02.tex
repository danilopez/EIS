...
\begin{figure}[h]
	\centering
		\frame{\includegraphics[width=0.4\textwidth]{./img/screenshot-camara-error.jpg}}
...
\begin{figure}[h]
	\centering
		\frame{\includegraphics[width=0.4\textwidth]{./img/screenshot-info-producto.png}}
...
\begin{figure}[H]
	\centering
		\frame{\includegraphics[width=0.4\textwidth]{./img/screenshot-boton-stock.png}}
...
\begin{figure}[H]
	\centering
		\frame{\includegraphics[width=0.4\textwidth]{./img/screenshot-error-gps.png}}
...
\begin{figure}[H]
	\centering
		\frame{\includegraphics[width=0.4\textwidth]{./img/screenshot-lista-tiendas.png}}
